...
namespace KeepMyOverridesPls
{
    ...
    public class Plugin
    {
        ...
        // public const string HarmonyId = "com.github.YourGitHub.KeepMyOverridesPls";
        // internal static readonly HarmonyLib.Harmony harmony = new HarmonyLib.Harmony(HarmonyId);

        internal static Plugin Instance { get; private set; }
        internal static IPALogger Log { get; private set; }
        internal static KeepMyOverridesPlsController PluginController { get { return KeepMyOverridesPlsController.Instance; } }
        ...
        */
        ...
        {
            new GameObject("KeepMyOverridesPlsController").AddComponent<KeepMyOverridesPlsController>();
            //ApplyHarmonyPatches();
        }
